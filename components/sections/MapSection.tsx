...
export default function MapSection() {
  ...
  return (
    <section className="relative w-full max-w-full overflow-x-hidden overflow-y-visible bg-white pb-12 sm:pb-16 md:pb-20">
      ...
      <div className="absolute top-0 left-0 right-0 h-48 sm:h-56 md:h-64 lg:h-80 xl:h-96 z-10 pointer-events-none" 
           style={{
      ...
      <div className="relative w-full max-w-full overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-32 sm:h-40 md:h-48 lg:h-64 xl:h-80 z-10 pointer-events-none"
             style={{
